...
class ImageNetTrainDataset(Dataset):
    ...
    @property
    def targets(self):
        """Alias for self.labels — required for compatibility with _NoisyLabelDataset."""
        return self.labels
...
def create_imagenet_dataloaders(train_dir: str = TRAIN_DIR,
                              val_dir: str = VAL_DIR,
                              val_csv: str = VAL_CSV,
    ...
    Args:
        ...
        val_csv: Path to CSV file mapping validation images to classes
        class_mapping_json: Path to imagenet_class_index.json file
...
if __name__ == "__main__":
    ...
    # print the total number of samples and classes
    print(f"\nTotal training samples: {len(train_loader.dataset)}")
